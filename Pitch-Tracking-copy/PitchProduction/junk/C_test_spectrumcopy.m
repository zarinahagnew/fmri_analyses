...
curdir = cd;
hcsdirs = { ...
'HC01/expr2014.05.06.T12.36.43_mainrun/speak',...
% 'HC02/expr2014.06.17.T12.53.53_mainrun/',...
% 'HC03/expr2014.06.17.T13.50.36_mainrun/', ...
% 'HC04/expr2014.06.17.T16.22.20_mainrun/',...
% 'HC05/expr2014.06.18.T15.14.02_mainrun/', ...
% 'HC06/expr2014.06.18.T16.18.27_mainrun/', ...
};
...
%  dir2proc = [hcsdirs{ihcs} '/speak'];
  ...
  [hcs(ihcs).ntrials,hcs(ihcs).nframes_min,hcs(ihcs).frame_taxis,hcs(ihcs).sigs] = get_sig_array(gooddata.wholetrial,frame_fs); % non cell array called sigs
